...
<div class="bg-white rounded-lg shadow-lg overflow-hidden mb-10 border border-gray-100">
  ...
  <div class="p-6 md:p-10">
    ...
    <?php if ($success): ?>
      <div class="bg-green-50 border border-green-200 text-green-700 px-6 py-10 rounded mb-6 text-center shadow-inner">
        ...
        <a href="<?= h(resolve_url('/')) ?>" class="inline-block mt-8 px-6 py-2 bg-white border border-green-300 rounded-full text-sm font-bold hover:bg-green-100 transition"><?= theme_t('Back to Home') ?></a>
      </div>
    <?php else: ?>
