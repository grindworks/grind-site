...
<div class="bg-white shadow-sm mb-8 p-6 border border-gray-200 rounded-lg widget-search">
    ...
    <form action="<?= $searchAction ?>" method="get" class="flex grinds-search-form">
        <input type="text" name="q" placeholder="<?= h(theme_t('search')) ?>" aria-label="<?= h(theme_t('search')) ?>" class="px-3 py-2 border border-gray-300 focus:border-grinds-red rounded-l focus:outline-none w-full text-sm placeholder-gray-500">
