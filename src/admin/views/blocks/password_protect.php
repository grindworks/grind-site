...
<div class="space-y-3 bg-theme-bg/40 p-4 border border-theme-warning/50 rounded-theme relative overflow-hidden" x-init="if(typeof block.data.password === 'undefined') block.data.password = ''; if(typeof block.data.message === 'undefined') block.data.message = '';">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
            ...
            <div class="relative" x-data="{ show: false }">
                <input :type="show ? 'text' : 'password'" x-model="block.data.password" class="w-full text-xs form-control-sm font-mono pr-8" placeholder="<?= _t('ph_password') ?>">
        ...
        <div>
            ...
            <input type="text" x-model="block.data.message" class="w-full text-xs form-control-sm" placeholder="<?= _t('ph_unlock_msg') ?>">
        </div>
    </div>
</div>
