...
2. Rename the file `src/plugins/_mail_otp_2fa.php` to `mail_otp_2fa.php` (remove the underscore).
...
2. `src/plugins/_mail_otp_2fa.php` のファイル名から先頭の `_` を削除し、`mail_otp_2fa.php` に変更します。
