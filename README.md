...
[![Version](https://img.shields.io/badge/version-1.6.5-blue.svg)](https://github.com/grindworks/grind-site/releases)
...
- **Contact Form Management:** Fully customizable contact forms with dynamic subject dropdowns, auto-reply emails, and automatic `Reply-To` routing.
...
- **お問い合わせフォーム管理:** 宛先や件名の選択肢、サンクスメッセージ、ユーザーへの自動返信メールなどを管理画面から柔軟に設定可能。管理者宛メールへの `Reply-To` にも対応しています。
